...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../accelerometer.sopcinfo
...
# Design Name 
# setting SOPC_NAME is accelerometer
SOPC_NAME := accelerometer
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1540988433
SOPC_SYSID_FLAG += --timestamp=1540988433
ELF_PATCH_FLAG  += --timestamp 1540988433
