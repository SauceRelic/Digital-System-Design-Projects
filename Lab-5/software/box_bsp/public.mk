...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios_video.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios_video
SOPC_NAME := nios_video
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8041060
SOPC_SYSID_FLAG += --sidp=0x8041060
ELF_PATCH_FLAG  += --sidp 0x8041060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1540476164
SOPC_SYSID_FLAG += --timestamp=1540476164
ELF_PATCH_FLAG  += --timestamp 1540476164
