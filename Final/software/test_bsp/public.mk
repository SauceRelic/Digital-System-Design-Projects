...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../accel_sketch.sopcinfo
...
# Design Name 
# setting SOPC_NAME is accel_sketch
SOPC_NAME := accel_sketch
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8081070
SOPC_SYSID_FLAG += --sidp=0x8081070
ELF_PATCH_FLAG  += --sidp 0x8081070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1541608274
SOPC_SYSID_FLAG += --timestamp=1541608274
ELF_PATCH_FLAG  += --timestamp 1541608274
